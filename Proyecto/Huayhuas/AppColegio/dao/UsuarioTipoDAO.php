    ...
    public function createTUsuario(UsuarioTipoDTO $tipo) {
        ...
        try {
            if ($this->findTUsuario($tipo->getDescripcion_tu()) == null) {
                ...
                $statement->bindParam(":descripcion_tu", $tipo->getDescripcion_tu(), PDO::PARAM_STR);
                $statement->bindParam(":seguridad_tu", $tipo->getSeguridad_tu(), PDO::PARAM_INT);
                $statement->bindParam(":planificacion_tu", $tipo->getPlanificacion_tu(), PDO::PARAM_INT);
                $statement->bindParam(":matricula_tu", $tipo->getMatricula_tu(), PDO::PARAM_INT);
                $statement->bindParam(":reportes_tu", $tipo->getReportes_tu(), PDO::PARAM_INT);
